...
struct L {
    ...
    var tradeWaitingForPeerOffer: String { t("상대의 제안을 기다리는 중…", "Waiting for their offer…", "相手の提案を待っています…", "Esperando su oferta…", "En attente de leur offre…", "Aguardando a oferta dele…", "Warte auf ihr Angebot…") }
    var tradeWaitingForPeerAccept: String { t("상대의 승인을 기다리는 중…", "Waiting for them to accept…", "相手の承認を待っています…", "Esperando que acepte…", "En attente de son acceptation…", "Aguardando ele aceitar…", "Warte auf ihre Zustimmung…") }
    var tradeWaitingForPeerConfirm: String { t("교환을 적용했어요 — 상대 확인을 기다리는 중…", "Trade applied — waiting for their confirmation…", "交換を適用しました — 相手の確認を待っています…", "Intercambio aplicado: esperando su confirmación…", "Échange appliqué — en attente de sa confirmation…", "Troca aplicada — aguardando a confirmação dele…", "Tausch angewendet — warte auf ihre Bestätigung…") }
    ...
    var tradeRejectedByPeer: String { t("상대가 교환을 거절했어요", "They declined the trade", "相手が交換を拒否しました", "Rechazó el intercambio", "Il a refusé l'échange", "Ele recusou a troca", "Der Tausch wurde abgelehnt") }
